    ...
    >
      <AgGridReact
        ...
        autoGroupColumnDef={{
          ...
          cellRendererParams: { checkbox:  function(params) {
            ...
            if(isGroupRow) {
              ...
              if(childRows) {
                console.log(childRows.filter(e => e.data.status === 'TVPC PENDING ACK').length);
              }
              if (childRows && childRows.filter(e => e.data.status === 'TVPC PENDING ACK').length > 0) {
                return false;
              } else {
                return true;
              }
